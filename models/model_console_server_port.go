...
// ConsoleServerPort is an object. Adds support for custom fields and tags.
...
func (m ConsoleServerPort) Validate() error {
...
func (m ConsoleServerPort) GetOccupied() bool {
	return m.Occupied
}

// SetOccupied sets the Occupied property
func (m *ConsoleServerPort) SetOccupied(val bool) {
	m.Occupied = val
}

// GetCable returns the Cable property
func (m ConsoleServerPort) GetCable() *NestedCable {
	return m.Cable
}

// SetCable sets the Cable property
func (m *ConsoleServerPort) SetCable(val *NestedCable) {
	m.Cable = val
}

// GetCableEnd returns the CableEnd property
func (m ConsoleServerPort) GetCableEnd() string {
	return m.CableEnd
}

// SetCableEnd sets the CableEnd property
func (m *ConsoleServerPort) SetCableEnd(val string) {
	m.CableEnd = val
}

// GetConnectedEndpoints returns the ConnectedEndpoints property
func (m ConsoleServerPort) GetConnectedEndpoints() []interface{} {
	return m.ConnectedEndpoints
}

// SetConnectedEndpoints sets the ConnectedEndpoints property
func (m *ConsoleServerPort) SetConnectedEndpoints(val []interface{}) {
	m.ConnectedEndpoints = val
}

// GetConnectedEndpointsReachable returns the ConnectedEndpointsReachable property
func (m ConsoleServerPort) GetConnectedEndpointsReachable() bool {
	return m.ConnectedEndpointsReachable
}

// SetConnectedEndpointsReachable sets the ConnectedEndpointsReachable property
func (m *ConsoleServerPort) SetConnectedEndpointsReachable(val bool) {
	m.ConnectedEndpointsReachable = val
}

// GetConnectedEndpointsType returns the ConnectedEndpointsType property
func (m ConsoleServerPort) GetConnectedEndpointsType() string {
	return m.ConnectedEndpointsType
}

// SetConnectedEndpointsType sets the ConnectedEndpointsType property
func (m *ConsoleServerPort) SetConnectedEndpointsType(val string) {
	m.ConnectedEndpointsType = val
}

// GetCreated returns the Created property
func (m ConsoleServerPort) GetCreated() *time.Time {
	return m.Created
}

// SetCreated sets the Created property
func (m *ConsoleServerPort) SetCreated(val *time.Time) {
	m.Created = val
}

// GetCustomFields returns the CustomFields property
func (m ConsoleServerPort) GetCustomFields() map[string]interface{} {
	return m.CustomFields
}

// SetCustomFields sets the CustomFields property
func (m *ConsoleServerPort) SetCustomFields(val map[string]interface{}) {
	m.CustomFields = val
}

// GetDescription returns the Description property
func (m ConsoleServerPort) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *ConsoleServerPort) SetDescription(val string) {
	m.Description = val
}

// GetDevice returns the Device property
func (m ConsoleServerPort) GetDevice() NestedDevice {
	return m.Device
}

// SetDevice sets the Device property
func (m *ConsoleServerPort) SetDevice(val NestedDevice) {
	m.Device = val
}

// GetDisplay returns the Display property
func (m ConsoleServerPort) GetDisplay() string {
	return m.Display
}

// SetDisplay sets the Display property
func (m *ConsoleServerPort) SetDisplay(val string) {
	m.Display = val
}

// GetId returns the Id property
func (m ConsoleServerPort) GetId() int32 {
	return m.Id
}

// SetId sets the Id property
func (m *ConsoleServerPort) SetId(val int32) {
	m.Id = val
}

// GetLabel returns the Label property
func (m ConsoleServerPort) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *ConsoleServerPort) SetLabel(val string) {
	m.Label = val
}

// GetLastUpdated returns the LastUpdated property
func (m ConsoleServerPort) GetLastUpdated() *time.Time {
	return m.LastUpdated
}

// SetLastUpdated sets the LastUpdated property
func (m *ConsoleServerPort) SetLastUpdated(val *time.Time) {
	m.LastUpdated = val
}

// GetLinkPeers returns the LinkPeers property
func (m ConsoleServerPort) GetLinkPeers() []interface{} {
	return m.LinkPeers
}

// SetLinkPeers sets the LinkPeers property
func (m *ConsoleServerPort) SetLinkPeers(val []interface{}) {
	m.LinkPeers = val
}

// GetLinkPeersType returns the LinkPeersType property
func (m ConsoleServerPort) GetLinkPeersType() string {
	return m.LinkPeersType
}

// SetLinkPeersType sets the LinkPeersType property
func (m *ConsoleServerPort) SetLinkPeersType(val string) {
	m.LinkPeersType = val
}

// GetMarkConnected returns the MarkConnected property
func (m ConsoleServerPort) GetMarkConnected() bool {
	return m.MarkConnected
}

// SetMarkConnected sets the MarkConnected property
func (m *ConsoleServerPort) SetMarkConnected(val bool) {
	m.MarkConnected = val
}

// GetModule returns the Module property
func (m ConsoleServerPort) GetModule() *ComponentNestedModule {
	return m.Module
}

// SetModule sets the Module property
func (m *ConsoleServerPort) SetModule(val *ComponentNestedModule) {
	m.Module = val
}

// GetName returns the Name property
func (m ConsoleServerPort) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *ConsoleServerPort) SetName(val string) {
	m.Name = val
}

// GetSpeed returns the Speed property
func (m ConsoleServerPort) GetSpeed() *struct {
	Label string `json:"label,omitempty" mapstructure:"label,omitempty"`
	Value string `json:"value,omitempty" mapstructure:"value,omitempty"`
} {
	return m.Speed
...
func (m *ConsoleServerPort) SetSpeed(val *struct {
	Label string `json:"label,omitempty" mapstructure:"label,omitempty"`
	Value string `json:"value,omitempty" mapstructure:"value,omitempty"`
}) {
	m.Speed = val
...
func (m ConsoleServerPort) GetTags() []NestedTag {
	return m.Tags
}

// SetTags sets the Tags property
func (m *ConsoleServerPort) SetTags(val []NestedTag) {
	m.Tags = val
}

// GetType returns the Type property
func (m ConsoleServerPort) GetType() *struct {
	Label string `json:"label,omitempty" mapstructure:"label,omitempty"`
	Value string `json:"value,omitempty" mapstructure:"value,omitempty"`
} {
	return m.Type
...
func (m *ConsoleServerPort) SetType(val *struct {
	Label string `json:"label,omitempty" mapstructure:"label,omitempty"`
	Value string `json:"value,omitempty" mapstructure:"value,omitempty"`
}) {
	m.Type = val
...
func (m ConsoleServerPort) GetUrl() string {
	return m.Url
}

// SetUrl sets the Url property
func (m *ConsoleServerPort) SetUrl(val string) {
	m.Url = val
}
