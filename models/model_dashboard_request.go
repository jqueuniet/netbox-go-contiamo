...
func (m DashboardRequest) Validate() error {
...
func (m DashboardRequest) GetConfig() map[string]interface{} {
	return m.Config
}

// SetConfig sets the Config property
func (m *DashboardRequest) SetConfig(val map[string]interface{}) {
	m.Config = val
}

// GetLayout returns the Layout property
func (m DashboardRequest) GetLayout() map[string]interface{} {
	return m.Layout
}

// SetLayout sets the Layout property
func (m *DashboardRequest) SetLayout(val map[string]interface{}) {
	m.Layout = val
}
