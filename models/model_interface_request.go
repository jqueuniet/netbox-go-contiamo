...
// InterfaceRequest is an object. Adds support for custom fields and tags.
type InterfaceRequest struct {
	...
	Bridge *NestedInterfaceRequest `json:"bridge,omitempty" mapstructure:"bridge,omitempty"`
	// CustomFields:
	...
	// dictionary of attributes which can be used to uniquely identify the related object. This class should be
	// subclassed to return a full representation of the related object on read.
	Lag *NestedInterfaceRequest `json:"lag,omitempty" mapstructure:"lag,omitempty"`
	// MacAddress:
	...
	// dictionary of attributes which can be used to uniquely identify the related object. This class should be
	// subclassed to return a full representation of the related object on read.
	Parent *NestedInterfaceRequest `json:"parent,omitempty" mapstructure:"parent,omitempty"`
	// PoeMode: * `pd` - PD
	// * `pse` - PSE
...
func (m InterfaceRequest) Validate() error {
...
func (m InterfaceRequest) GetBridge() *NestedInterfaceRequest {
	return m.Bridge
}

// SetBridge sets the Bridge property
func (m *InterfaceRequest) SetBridge(val *NestedInterfaceRequest) {
	m.Bridge = val
}

// GetCustomFields returns the CustomFields property
func (m InterfaceRequest) GetCustomFields() map[string]interface{} {
	return m.CustomFields
}

// SetCustomFields sets the CustomFields property
func (m *InterfaceRequest) SetCustomFields(val map[string]interface{}) {
	m.CustomFields = val
}

// GetDescription returns the Description property
func (m InterfaceRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *InterfaceRequest) SetDescription(val string) {
	m.Description = val
}

// GetDevice returns the Device property
func (m InterfaceRequest) GetDevice() NestedDeviceRequest {
	return m.Device
}

// SetDevice sets the Device property
func (m *InterfaceRequest) SetDevice(val NestedDeviceRequest) {
	m.Device = val
}

// GetDuplex returns the Duplex property
func (m InterfaceRequest) GetDuplex() *string {
	return m.Duplex
}

// SetDuplex sets the Duplex property
func (m *InterfaceRequest) SetDuplex(val *string) {
	m.Duplex = val
}

// GetEnabled returns the Enabled property
func (m InterfaceRequest) GetEnabled() bool {
	return m.Enabled
}

// SetEnabled sets the Enabled property
func (m *InterfaceRequest) SetEnabled(val bool) {
	m.Enabled = val
}

// GetLabel returns the Label property
func (m InterfaceRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *InterfaceRequest) SetLabel(val string) {
	m.Label = val
}

// GetLag returns the Lag property
func (m InterfaceRequest) GetLag() *NestedInterfaceRequest {
	return m.Lag
}

// SetLag sets the Lag property
func (m *InterfaceRequest) SetLag(val *NestedInterfaceRequest) {
	m.Lag = val
}

// GetMacAddress returns the MacAddress property
func (m InterfaceRequest) GetMacAddress() *string {
	return m.MacAddress
}

// SetMacAddress sets the MacAddress property
func (m *InterfaceRequest) SetMacAddress(val *string) {
	m.MacAddress = val
}

// GetMarkConnected returns the MarkConnected property
func (m InterfaceRequest) GetMarkConnected() bool {
	return m.MarkConnected
}

// SetMarkConnected sets the MarkConnected property
func (m *InterfaceRequest) SetMarkConnected(val bool) {
	m.MarkConnected = val
}

// GetMgmtOnly returns the MgmtOnly property
func (m InterfaceRequest) GetMgmtOnly() bool {
	return m.MgmtOnly
}

// SetMgmtOnly sets the MgmtOnly property
func (m *InterfaceRequest) SetMgmtOnly(val bool) {
	m.MgmtOnly = val
}

// GetMode returns the Mode property
func (m InterfaceRequest) GetMode() *string {
	return m.Mode
}

// SetMode sets the Mode property
func (m *InterfaceRequest) SetMode(val *string) {
	m.Mode = val
}

// GetModule returns the Module property
func (m InterfaceRequest) GetModule() *ComponentNestedModuleRequest {
	return m.Module
}

// SetModule sets the Module property
func (m *InterfaceRequest) SetModule(val *ComponentNestedModuleRequest) {
	m.Module = val
}

// GetMtu returns the Mtu property
func (m InterfaceRequest) GetMtu() *int32 {
	return m.Mtu
}

// SetMtu sets the Mtu property
func (m *InterfaceRequest) SetMtu(val *int32) {
	m.Mtu = val
}
...
func (m *InterfaceRequest) SetName(val string) {
	m.Name = val
}

// GetParent returns the Parent property
func (m InterfaceRequest) GetParent() *NestedInterfaceRequest {
	return m.Parent
}

// SetParent sets the Parent property
func (m *InterfaceRequest) SetParent(val *NestedInterfaceRequest) {
	m.Parent = val
}

// GetPoeMode returns the PoeMode property
func (m InterfaceRequest) GetPoeMode() *string {
	return m.PoeMode
}

// SetPoeMode sets the PoeMode property
func (m *InterfaceRequest) SetPoeMode(val *string) {
	m.PoeMode = val
}

// GetPoeType returns the PoeType property
func (m InterfaceRequest) GetPoeType() *string {
	return m.PoeType
}

// SetPoeType sets the PoeType property
func (m *InterfaceRequest) SetPoeType(val *string) {
	m.PoeType = val
}

// GetRfChannel returns the RfChannel property
func (m InterfaceRequest) GetRfChannel() *string {
	return m.RfChannel
}

// SetRfChannel sets the RfChannel property
func (m *InterfaceRequest) SetRfChannel(val *string) {
	m.RfChannel = val
}

// GetRfChannelFrequency returns the RfChannelFrequency property
func (m InterfaceRequest) GetRfChannelFrequency() *float64 {
	return m.RfChannelFrequency
}

// SetRfChannelFrequency sets the RfChannelFrequency property
func (m *InterfaceRequest) SetRfChannelFrequency(val *float64) {
	m.RfChannelFrequency = val
}

// GetRfChannelWidth returns the RfChannelWidth property
func (m InterfaceRequest) GetRfChannelWidth() *float64 {
	return m.RfChannelWidth
}

// SetRfChannelWidth sets the RfChannelWidth property
func (m *InterfaceRequest) SetRfChannelWidth(val *float64) {
	m.RfChannelWidth = val
}

// GetRfRole returns the RfRole property
func (m InterfaceRequest) GetRfRole() *string {
	return m.RfRole
}

// SetRfRole sets the RfRole property
func (m *InterfaceRequest) SetRfRole(val *string) {
	m.RfRole = val
}

// GetSpeed returns the Speed property
func (m InterfaceRequest) GetSpeed() *int32 {
	return m.Speed
}

// SetSpeed sets the Speed property
func (m *InterfaceRequest) SetSpeed(val *int32) {
	m.Speed = val
}

// GetTaggedVlans returns the TaggedVlans property
func (m InterfaceRequest) GetTaggedVlans() []int32 {
	return m.TaggedVlans
}

// SetTaggedVlans sets the TaggedVlans property
func (m *InterfaceRequest) SetTaggedVlans(val []int32) {
	m.TaggedVlans = val
}

// GetTags returns the Tags property
func (m InterfaceRequest) GetTags() []NestedTagRequest {
	return m.Tags
}

// SetTags sets the Tags property
func (m *InterfaceRequest) SetTags(val []NestedTagRequest) {
	m.Tags = val
}

// GetTxPower returns the TxPower property
func (m InterfaceRequest) GetTxPower() *int32 {
	return m.TxPower
}

// SetTxPower sets the TxPower property
func (m *InterfaceRequest) SetTxPower(val *int32) {
	m.TxPower = val
}

// GetType returns the Type property
func (m InterfaceRequest) GetType() string {
	return m.Type
}

// SetType sets the Type property
func (m *InterfaceRequest) SetType(val string) {
	m.Type = val
}

// GetUntaggedVlan returns the UntaggedVlan property
func (m InterfaceRequest) GetUntaggedVlan() *NestedVLANRequest {
	return m.UntaggedVlan
}

// SetUntaggedVlan sets the UntaggedVlan property
func (m *InterfaceRequest) SetUntaggedVlan(val *NestedVLANRequest) {
	m.UntaggedVlan = val
}

// GetVdcs returns the Vdcs property
func (m InterfaceRequest) GetVdcs() []int32 {
	return m.Vdcs
}

// SetVdcs sets the Vdcs property
func (m *InterfaceRequest) SetVdcs(val []int32) {
	m.Vdcs = val
}

// GetVrf returns the Vrf property
func (m InterfaceRequest) GetVrf() *NestedVRFRequest {
	return m.Vrf
}

// SetVrf sets the Vrf property
func (m *InterfaceRequest) SetVrf(val *NestedVRFRequest) {
	m.Vrf = val
}

// GetWirelessLans returns the WirelessLans property
func (m InterfaceRequest) GetWirelessLans() []int32 {
	return m.WirelessLans
}

// SetWirelessLans sets the WirelessLans property
func (m *InterfaceRequest) SetWirelessLans(val []int32) {
	m.WirelessLans = val
}

// GetWwn returns the Wwn property
func (m InterfaceRequest) GetWwn() string {
	return m.Wwn
}

// SetWwn sets the Wwn property
func (m *InterfaceRequest) SetWwn(val string) {
	m.Wwn = val
}
