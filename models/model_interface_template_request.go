...
// InterfaceTemplateRequest is an object. Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during
...
type InterfaceTemplateRequest struct {
	...
	Bridge *NestedInterfaceTemplateRequest `json:"bridge,omitempty" mapstructure:"bridge,omitempty"`
	// Description:
...
func (m InterfaceTemplateRequest) Validate() error {
...
func (m InterfaceTemplateRequest) GetBridge() *NestedInterfaceTemplateRequest {
	return m.Bridge
}

// SetBridge sets the Bridge property
func (m *InterfaceTemplateRequest) SetBridge(val *NestedInterfaceTemplateRequest) {
	m.Bridge = val
}

// GetDescription returns the Description property
func (m InterfaceTemplateRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *InterfaceTemplateRequest) SetDescription(val string) {
	m.Description = val
}

// GetDeviceType returns the DeviceType property
func (m InterfaceTemplateRequest) GetDeviceType() *NestedDeviceTypeRequest {
	return m.DeviceType
}

// SetDeviceType sets the DeviceType property
func (m *InterfaceTemplateRequest) SetDeviceType(val *NestedDeviceTypeRequest) {
	m.DeviceType = val
}

// GetEnabled returns the Enabled property
func (m InterfaceTemplateRequest) GetEnabled() bool {
	return m.Enabled
}

// SetEnabled sets the Enabled property
func (m *InterfaceTemplateRequest) SetEnabled(val bool) {
	m.Enabled = val
}

// GetLabel returns the Label property
func (m InterfaceTemplateRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *InterfaceTemplateRequest) SetLabel(val string) {
	m.Label = val
}

// GetMgmtOnly returns the MgmtOnly property
func (m InterfaceTemplateRequest) GetMgmtOnly() bool {
	return m.MgmtOnly
}

// SetMgmtOnly sets the MgmtOnly property
func (m *InterfaceTemplateRequest) SetMgmtOnly(val bool) {
	m.MgmtOnly = val
}

// GetModuleType returns the ModuleType property
func (m InterfaceTemplateRequest) GetModuleType() *NestedModuleTypeRequest {
	return m.ModuleType
}

// SetModuleType sets the ModuleType property
func (m *InterfaceTemplateRequest) SetModuleType(val *NestedModuleTypeRequest) {
	m.ModuleType = val
}

// GetName returns the Name property
func (m InterfaceTemplateRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *InterfaceTemplateRequest) SetName(val string) {
	m.Name = val
}

// GetPoeMode returns the PoeMode property
func (m InterfaceTemplateRequest) GetPoeMode() *string {
	return m.PoeMode
}

// SetPoeMode sets the PoeMode property
func (m *InterfaceTemplateRequest) SetPoeMode(val *string) {
	m.PoeMode = val
}

// GetPoeType returns the PoeType property
func (m InterfaceTemplateRequest) GetPoeType() *string {
	return m.PoeType
}

// SetPoeType sets the PoeType property
func (m *InterfaceTemplateRequest) SetPoeType(val *string) {
	m.PoeType = val
}

// GetType returns the Type property
func (m InterfaceTemplateRequest) GetType() string {
	return m.Type
}

// SetType sets the Type property
func (m *InterfaceTemplateRequest) SetType(val string) {
	m.Type = val
}
