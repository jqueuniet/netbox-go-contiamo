...
// PaginatedAggregateList is an object.
type PaginatedAggregateList struct {
	...
	// Results:
	Results []Aggregate `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedAggregateList) Validate() error {
...
func (m PaginatedAggregateList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedAggregateList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedAggregateList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedAggregateList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedAggregateList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedAggregateList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedAggregateList) GetResults() []Aggregate {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedAggregateList) SetResults(val []Aggregate) {
	m.Results = val
}
