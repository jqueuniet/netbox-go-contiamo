...
type PaginatedASNList struct {
	...
	// Results:
	Results []ASN `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedASNList) Validate() error {
...
func (m PaginatedASNList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedASNList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedASNList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedASNList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedASNList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedASNList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedASNList) GetResults() []ASN {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedASNList) SetResults(val []ASN) {
	m.Results = val
}
