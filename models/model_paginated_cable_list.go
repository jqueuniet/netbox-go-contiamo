...
// PaginatedCableList is an object.
type PaginatedCableList struct {
	...
	// Results:
	Results []Cable `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedCableList) Validate() error {
...
func (m PaginatedCableList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedCableList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedCableList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedCableList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedCableList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedCableList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedCableList) GetResults() []Cable {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedCableList) SetResults(val []Cable) {
	m.Results = val
}
