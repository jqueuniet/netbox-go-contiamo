...
// PaginatedCircuitTypeList is an object.
type PaginatedCircuitTypeList struct {
	...
	// Results:
	Results []CircuitType `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedCircuitTypeList) Validate() error {
...
func (m PaginatedCircuitTypeList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedCircuitTypeList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedCircuitTypeList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedCircuitTypeList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedCircuitTypeList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedCircuitTypeList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedCircuitTypeList) GetResults() []CircuitType {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedCircuitTypeList) SetResults(val []CircuitType) {
	m.Results = val
}
