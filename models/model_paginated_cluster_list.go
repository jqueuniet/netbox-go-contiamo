...
// PaginatedClusterList is an object.
type PaginatedClusterList struct {
	...
	// Results:
	Results []Cluster `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedClusterList) Validate() error {
...
func (m PaginatedClusterList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedClusterList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedClusterList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedClusterList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedClusterList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedClusterList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedClusterList) GetResults() []Cluster {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedClusterList) SetResults(val []Cluster) {
	m.Results = val
}
