...
// PaginatedClusterTypeList is an object.
type PaginatedClusterTypeList struct {
	...
	// Results:
	Results []ClusterType `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedClusterTypeList) Validate() error {
...
func (m PaginatedClusterTypeList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedClusterTypeList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedClusterTypeList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedClusterTypeList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedClusterTypeList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedClusterTypeList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedClusterTypeList) GetResults() []ClusterType {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedClusterTypeList) SetResults(val []ClusterType) {
	m.Results = val
}
