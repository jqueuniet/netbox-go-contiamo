...
// PaginatedConfigContextList is an object.
type PaginatedConfigContextList struct {
	...
	// Results:
	Results []ConfigContext `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedConfigContextList) Validate() error {
...
func (m PaginatedConfigContextList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedConfigContextList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedConfigContextList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedConfigContextList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedConfigContextList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedConfigContextList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedConfigContextList) GetResults() []ConfigContext {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedConfigContextList) SetResults(val []ConfigContext) {
	m.Results = val
}
