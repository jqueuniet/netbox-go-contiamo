...
// PaginatedConsolePortList is an object.
type PaginatedConsolePortList struct {
	...
	// Results:
	Results []ConsolePort `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedConsolePortList) Validate() error {
...
func (m PaginatedConsolePortList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedConsolePortList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedConsolePortList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedConsolePortList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedConsolePortList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedConsolePortList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedConsolePortList) GetResults() []ConsolePort {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedConsolePortList) SetResults(val []ConsolePort) {
	m.Results = val
}
