...
// PaginatedContactGroupList is an object.
type PaginatedContactGroupList struct {
	...
	// Results:
	Results []ContactGroup `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedContactGroupList) Validate() error {
...
func (m PaginatedContactGroupList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedContactGroupList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedContactGroupList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedContactGroupList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedContactGroupList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedContactGroupList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedContactGroupList) GetResults() []ContactGroup {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedContactGroupList) SetResults(val []ContactGroup) {
	m.Results = val
}
