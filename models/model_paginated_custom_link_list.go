...
// PaginatedCustomLinkList is an object.
type PaginatedCustomLinkList struct {
	...
	// Results:
	Results []CustomLink `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedCustomLinkList) Validate() error {
...
func (m PaginatedCustomLinkList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedCustomLinkList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedCustomLinkList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedCustomLinkList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedCustomLinkList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedCustomLinkList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedCustomLinkList) GetResults() []CustomLink {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedCustomLinkList) SetResults(val []CustomLink) {
	m.Results = val
}
