...
// PaginatedDataSourceList is an object.
type PaginatedDataSourceList struct {
	...
	// Results:
	Results []DataSource `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedDataSourceList) Validate() error {
...
func (m PaginatedDataSourceList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedDataSourceList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedDataSourceList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedDataSourceList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedDataSourceList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedDataSourceList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedDataSourceList) GetResults() []DataSource {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedDataSourceList) SetResults(val []DataSource) {
	m.Results = val
}
