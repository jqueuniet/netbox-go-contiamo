...
// PaginatedDeviceRoleList is an object.
type PaginatedDeviceRoleList struct {
	...
	// Results:
	Results []DeviceRole `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedDeviceRoleList) Validate() error {
...
func (m PaginatedDeviceRoleList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedDeviceRoleList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedDeviceRoleList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedDeviceRoleList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedDeviceRoleList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedDeviceRoleList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedDeviceRoleList) GetResults() []DeviceRole {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedDeviceRoleList) SetResults(val []DeviceRole) {
	m.Results = val
}
