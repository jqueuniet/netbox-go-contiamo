...
// PaginatedDeviceTypeList is an object.
type PaginatedDeviceTypeList struct {
	...
	// Results:
	Results []DeviceType `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedDeviceTypeList) Validate() error {
...
func (m PaginatedDeviceTypeList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedDeviceTypeList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedDeviceTypeList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedDeviceTypeList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedDeviceTypeList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedDeviceTypeList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedDeviceTypeList) GetResults() []DeviceType {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedDeviceTypeList) SetResults(val []DeviceType) {
	m.Results = val
}
