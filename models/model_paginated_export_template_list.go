...
// PaginatedExportTemplateList is an object.
type PaginatedExportTemplateList struct {
	...
	// Results:
	Results []ExportTemplate `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedExportTemplateList) Validate() error {
...
func (m PaginatedExportTemplateList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedExportTemplateList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedExportTemplateList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedExportTemplateList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedExportTemplateList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedExportTemplateList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedExportTemplateList) GetResults() []ExportTemplate {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedExportTemplateList) SetResults(val []ExportTemplate) {
	m.Results = val
}
