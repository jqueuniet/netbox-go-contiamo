...
// PaginatedFHRPGroupList is an object.
type PaginatedFHRPGroupList struct {
	...
	// Results:
	Results []FHRPGroup `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedFHRPGroupList) Validate() error {
...
func (m PaginatedFHRPGroupList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedFHRPGroupList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedFHRPGroupList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedFHRPGroupList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedFHRPGroupList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedFHRPGroupList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedFHRPGroupList) GetResults() []FHRPGroup {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedFHRPGroupList) SetResults(val []FHRPGroup) {
	m.Results = val
}
