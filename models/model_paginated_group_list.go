...
// PaginatedGroupList is an object.
type PaginatedGroupList struct {
	...
	// Results:
	Results []Group `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedGroupList) Validate() error {
...
func (m PaginatedGroupList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedGroupList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedGroupList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedGroupList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedGroupList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedGroupList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedGroupList) GetResults() []Group {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedGroupList) SetResults(val []Group) {
	m.Results = val
}
