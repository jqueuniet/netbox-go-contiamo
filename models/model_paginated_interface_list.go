...
// PaginatedInterfaceList is an object.
type PaginatedInterfaceList struct {
	...
	// Results:
	Results []Interface `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedInterfaceList) Validate() error {
...
func (m PaginatedInterfaceList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedInterfaceList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedInterfaceList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedInterfaceList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedInterfaceList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedInterfaceList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedInterfaceList) GetResults() []Interface {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedInterfaceList) SetResults(val []Interface) {
	m.Results = val
}
