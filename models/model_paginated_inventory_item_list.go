...
// PaginatedInventoryItemList is an object.
type PaginatedInventoryItemList struct {
	...
	// Results:
	Results []InventoryItem `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedInventoryItemList) Validate() error {
...
func (m PaginatedInventoryItemList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedInventoryItemList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedInventoryItemList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedInventoryItemList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedInventoryItemList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedInventoryItemList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedInventoryItemList) GetResults() []InventoryItem {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedInventoryItemList) SetResults(val []InventoryItem) {
	m.Results = val
}
