...
// PaginatedIPAddressList is an object.
type PaginatedIPAddressList struct {
	...
	// Results:
	Results []IPAddress `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedIPAddressList) Validate() error {
...
func (m PaginatedIPAddressList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedIPAddressList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedIPAddressList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedIPAddressList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedIPAddressList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedIPAddressList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedIPAddressList) GetResults() []IPAddress {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedIPAddressList) SetResults(val []IPAddress) {
	m.Results = val
}
