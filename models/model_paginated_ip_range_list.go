...
// PaginatedIPRangeList is an object.
type PaginatedIPRangeList struct {
	...
	// Results:
	Results []IPRange `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedIPRangeList) Validate() error {
...
func (m PaginatedIPRangeList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedIPRangeList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedIPRangeList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedIPRangeList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedIPRangeList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedIPRangeList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedIPRangeList) GetResults() []IPRange {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedIPRangeList) SetResults(val []IPRange) {
	m.Results = val
}
