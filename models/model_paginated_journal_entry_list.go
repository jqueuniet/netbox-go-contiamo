...
// PaginatedJournalEntryList is an object.
type PaginatedJournalEntryList struct {
	...
	// Results:
	Results []JournalEntry `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedJournalEntryList) Validate() error {
...
func (m PaginatedJournalEntryList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedJournalEntryList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedJournalEntryList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedJournalEntryList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedJournalEntryList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedJournalEntryList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedJournalEntryList) GetResults() []JournalEntry {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedJournalEntryList) SetResults(val []JournalEntry) {
	m.Results = val
}
