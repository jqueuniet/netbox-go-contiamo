...
// PaginatedL2VPNList is an object.
type PaginatedL2VPNList struct {
	...
	// Results:
	Results []L2VPN `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedL2VPNList) Validate() error {
...
func (m PaginatedL2VPNList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedL2VPNList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedL2VPNList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedL2VPNList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedL2VPNList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedL2VPNList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedL2VPNList) GetResults() []L2VPN {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedL2VPNList) SetResults(val []L2VPN) {
	m.Results = val
}
