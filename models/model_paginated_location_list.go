...
// PaginatedLocationList is an object.
type PaginatedLocationList struct {
	...
	// Results:
	Results []Location `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedLocationList) Validate() error {
...
func (m PaginatedLocationList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedLocationList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedLocationList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedLocationList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedLocationList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedLocationList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedLocationList) GetResults() []Location {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedLocationList) SetResults(val []Location) {
	m.Results = val
}
