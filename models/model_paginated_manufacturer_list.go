...
// PaginatedManufacturerList is an object.
type PaginatedManufacturerList struct {
	...
	// Results:
	Results []Manufacturer `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedManufacturerList) Validate() error {
...
func (m PaginatedManufacturerList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedManufacturerList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedManufacturerList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedManufacturerList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedManufacturerList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedManufacturerList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedManufacturerList) GetResults() []Manufacturer {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedManufacturerList) SetResults(val []Manufacturer) {
	m.Results = val
}
