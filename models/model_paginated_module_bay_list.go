...
// PaginatedModuleBayList is an object.
type PaginatedModuleBayList struct {
	...
	// Results:
	Results []ModuleBay `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedModuleBayList) Validate() error {
...
func (m PaginatedModuleBayList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedModuleBayList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedModuleBayList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedModuleBayList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedModuleBayList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedModuleBayList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedModuleBayList) GetResults() []ModuleBay {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedModuleBayList) SetResults(val []ModuleBay) {
	m.Results = val
}
