...
// PaginatedModuleList is an object.
type PaginatedModuleList struct {
	...
	// Results:
	Results []Module `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedModuleList) Validate() error {
...
func (m PaginatedModuleList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedModuleList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedModuleList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedModuleList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedModuleList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedModuleList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedModuleList) GetResults() []Module {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedModuleList) SetResults(val []Module) {
	m.Results = val
}
