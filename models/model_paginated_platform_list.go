...
// PaginatedPlatformList is an object.
type PaginatedPlatformList struct {
	...
	// Results:
	Results []Platform `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedPlatformList) Validate() error {
...
func (m PaginatedPlatformList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedPlatformList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedPlatformList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedPlatformList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedPlatformList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedPlatformList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedPlatformList) GetResults() []Platform {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedPlatformList) SetResults(val []Platform) {
	m.Results = val
}
