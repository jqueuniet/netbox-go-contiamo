...
// PaginatedPowerFeedList is an object.
type PaginatedPowerFeedList struct {
	...
	// Results:
	Results []PowerFeed `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedPowerFeedList) Validate() error {
...
func (m PaginatedPowerFeedList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedPowerFeedList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedPowerFeedList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedPowerFeedList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedPowerFeedList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedPowerFeedList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedPowerFeedList) GetResults() []PowerFeed {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedPowerFeedList) SetResults(val []PowerFeed) {
	m.Results = val
}
