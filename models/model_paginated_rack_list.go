...
// PaginatedRackList is an object.
type PaginatedRackList struct {
	...
	// Results:
	Results []Rack `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedRackList) Validate() error {
...
func (m PaginatedRackList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedRackList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedRackList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedRackList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedRackList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedRackList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedRackList) GetResults() []Rack {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedRackList) SetResults(val []Rack) {
	m.Results = val
}
