...
// PaginatedRearPortList is an object.
type PaginatedRearPortList struct {
	...
	// Results:
	Results []RearPort `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedRearPortList) Validate() error {
...
func (m PaginatedRearPortList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedRearPortList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedRearPortList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedRearPortList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedRearPortList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedRearPortList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedRearPortList) GetResults() []RearPort {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedRearPortList) SetResults(val []RearPort) {
	m.Results = val
}
