...
// PaginatedRegionList is an object.
type PaginatedRegionList struct {
	...
	// Results:
	Results []Region `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedRegionList) Validate() error {
...
func (m PaginatedRegionList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedRegionList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedRegionList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedRegionList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedRegionList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedRegionList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedRegionList) GetResults() []Region {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedRegionList) SetResults(val []Region) {
	m.Results = val
}
