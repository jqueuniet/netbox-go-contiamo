...
type PaginatedRIRList struct {
	...
	// Results:
	Results []RIR `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedRIRList) Validate() error {
...
func (m PaginatedRIRList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedRIRList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedRIRList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedRIRList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedRIRList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedRIRList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedRIRList) GetResults() []RIR {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedRIRList) SetResults(val []RIR) {
	m.Results = val
}
