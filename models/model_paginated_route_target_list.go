...
// PaginatedRouteTargetList is an object.
type PaginatedRouteTargetList struct {
	...
	// Results:
	Results []RouteTarget `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedRouteTargetList) Validate() error {
...
func (m PaginatedRouteTargetList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedRouteTargetList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedRouteTargetList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedRouteTargetList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedRouteTargetList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedRouteTargetList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedRouteTargetList) GetResults() []RouteTarget {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedRouteTargetList) SetResults(val []RouteTarget) {
	m.Results = val
}
