...
// PaginatedServiceList is an object.
type PaginatedServiceList struct {
	...
	// Results:
	Results []Service `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedServiceList) Validate() error {
...
func (m PaginatedServiceList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedServiceList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedServiceList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedServiceList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedServiceList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedServiceList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedServiceList) GetResults() []Service {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedServiceList) SetResults(val []Service) {
	m.Results = val
}
