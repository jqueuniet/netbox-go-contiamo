...
// PaginatedSiteList is an object.
type PaginatedSiteList struct {
	...
	// Results:
	Results []Site `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedSiteList) Validate() error {
...
func (m PaginatedSiteList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedSiteList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedSiteList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedSiteList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedSiteList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedSiteList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedSiteList) GetResults() []Site {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedSiteList) SetResults(val []Site) {
	m.Results = val
}
