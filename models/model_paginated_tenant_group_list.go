...
// PaginatedTenantGroupList is an object.
type PaginatedTenantGroupList struct {
	...
	// Results:
	Results []TenantGroup `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedTenantGroupList) Validate() error {
...
func (m PaginatedTenantGroupList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedTenantGroupList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedTenantGroupList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedTenantGroupList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedTenantGroupList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedTenantGroupList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedTenantGroupList) GetResults() []TenantGroup {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedTenantGroupList) SetResults(val []TenantGroup) {
	m.Results = val
}
