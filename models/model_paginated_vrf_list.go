...
type PaginatedVRFList struct {
	...
	// Results:
	Results []VRF `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedVRFList) Validate() error {
...
func (m PaginatedVRFList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedVRFList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedVRFList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedVRFList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedVRFList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedVRFList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedVRFList) GetResults() []VRF {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedVRFList) SetResults(val []VRF) {
	m.Results = val
}
