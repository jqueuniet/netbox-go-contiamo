...
// PaginatedWebhookList is an object.
type PaginatedWebhookList struct {
	...
	// Results:
	Results []Webhook `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedWebhookList) Validate() error {
...
func (m PaginatedWebhookList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedWebhookList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedWebhookList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedWebhookList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedWebhookList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedWebhookList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedWebhookList) GetResults() []Webhook {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedWebhookList) SetResults(val []Webhook) {
	m.Results = val
}
