...
// PaginatedWirelessLANList is an object.
type PaginatedWirelessLANList struct {
	...
	// Results:
	Results []WirelessLAN `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedWirelessLANList) Validate() error {
...
func (m PaginatedWirelessLANList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedWirelessLANList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedWirelessLANList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedWirelessLANList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedWirelessLANList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedWirelessLANList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedWirelessLANList) GetResults() []WirelessLAN {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedWirelessLANList) SetResults(val []WirelessLAN) {
	m.Results = val
}
