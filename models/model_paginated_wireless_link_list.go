...
// PaginatedWirelessLinkList is an object.
type PaginatedWirelessLinkList struct {
	...
	// Results:
	Results []WirelessLink `json:"results,omitempty" mapstructure:"results,omitempty"`
}

// Validate implements basic validation for this model
func (m PaginatedWirelessLinkList) Validate() error {
...
func (m PaginatedWirelessLinkList) GetCount() int32 {
	return m.Count
}

// SetCount sets the Count property
func (m *PaginatedWirelessLinkList) SetCount(val int32) {
	m.Count = val
}

// GetNext returns the Next property
func (m PaginatedWirelessLinkList) GetNext() *string {
	return m.Next
}

// SetNext sets the Next property
func (m *PaginatedWirelessLinkList) SetNext(val *string) {
	m.Next = val
}

// GetPrevious returns the Previous property
func (m PaginatedWirelessLinkList) GetPrevious() *string {
	return m.Previous
}

// SetPrevious sets the Previous property
func (m *PaginatedWirelessLinkList) SetPrevious(val *string) {
	m.Previous = val
}

// GetResults returns the Results property
func (m PaginatedWirelessLinkList) GetResults() []WirelessLink {
	return m.Results
}

// SetResults sets the Results property
func (m *PaginatedWirelessLinkList) SetResults(val []WirelessLink) {
	m.Results = val
}
