...
// patchedWritableCustomFieldRequestNamePattern is the validation pattern for PatchedWritableCustomFieldRequest.Name
var patchedWritableCustomFieldRequestNamePattern = regexp.MustCompile(`^[a-z0-9_]+$`)

// PatchedWritableCustomFieldRequest is an object. Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during
...
func (m PatchedWritableCustomFieldRequest) Validate() error {
	return validation.Errors{
		...
		"name": validation.Validate(
			m.Name, validation.Length(1, 50), validation.Match(patchedWritableCustomFieldRequestNamePattern),
		),
...
func (m PatchedWritableCustomFieldRequest) GetChoices() []string {
	return m.Choices
}

// SetChoices sets the Choices property
func (m *PatchedWritableCustomFieldRequest) SetChoices(val []string) {
	m.Choices = val
}

// GetContentTypes returns the ContentTypes property
func (m PatchedWritableCustomFieldRequest) GetContentTypes() []string {
	return m.ContentTypes
}

// SetContentTypes sets the ContentTypes property
func (m *PatchedWritableCustomFieldRequest) SetContentTypes(val []string) {
	m.ContentTypes = val
}

// GetDefault returns the Default property
func (m PatchedWritableCustomFieldRequest) GetDefault() map[string]interface{} {
	return m.Default
}

// SetDefault sets the Default property
func (m *PatchedWritableCustomFieldRequest) SetDefault(val map[string]interface{}) {
	m.Default = val
}

// GetDescription returns the Description property
func (m PatchedWritableCustomFieldRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *PatchedWritableCustomFieldRequest) SetDescription(val string) {
	m.Description = val
}

// GetFilterLogic returns the FilterLogic property
func (m PatchedWritableCustomFieldRequest) GetFilterLogic() string {
	return m.FilterLogic
}

// SetFilterLogic sets the FilterLogic property
func (m *PatchedWritableCustomFieldRequest) SetFilterLogic(val string) {
	m.FilterLogic = val
}

// GetGroupName returns the GroupName property
func (m PatchedWritableCustomFieldRequest) GetGroupName() string {
	return m.GroupName
}

// SetGroupName sets the GroupName property
func (m *PatchedWritableCustomFieldRequest) SetGroupName(val string) {
	m.GroupName = val
}

// GetIsCloneable returns the IsCloneable property
func (m PatchedWritableCustomFieldRequest) GetIsCloneable() bool {
	return m.IsCloneable
}

// SetIsCloneable sets the IsCloneable property
func (m *PatchedWritableCustomFieldRequest) SetIsCloneable(val bool) {
	m.IsCloneable = val
}

// GetLabel returns the Label property
func (m PatchedWritableCustomFieldRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *PatchedWritableCustomFieldRequest) SetLabel(val string) {
	m.Label = val
}

// GetName returns the Name property
func (m PatchedWritableCustomFieldRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *PatchedWritableCustomFieldRequest) SetName(val string) {
	m.Name = val
}

// GetObjectType returns the ObjectType property
func (m PatchedWritableCustomFieldRequest) GetObjectType() string {
	return m.ObjectType
}

// SetObjectType sets the ObjectType property
func (m *PatchedWritableCustomFieldRequest) SetObjectType(val string) {
	m.ObjectType = val
}

// GetRequired returns the Required property
func (m PatchedWritableCustomFieldRequest) GetRequired() bool {
	return m.Required
}

// SetRequired sets the Required property
func (m *PatchedWritableCustomFieldRequest) SetRequired(val bool) {
	m.Required = val
}

// GetSearchWeight returns the SearchWeight property
func (m PatchedWritableCustomFieldRequest) GetSearchWeight() int32 {
	return m.SearchWeight
}

// SetSearchWeight sets the SearchWeight property
func (m *PatchedWritableCustomFieldRequest) SetSearchWeight(val int32) {
	m.SearchWeight = val
}

// GetType returns the Type property
func (m PatchedWritableCustomFieldRequest) GetType() string {
	return m.Type
}

// SetType sets the Type property
func (m *PatchedWritableCustomFieldRequest) SetType(val string) {
	m.Type = val
}

// GetUiVisibility returns the UiVisibility property
func (m PatchedWritableCustomFieldRequest) GetUiVisibility() string {
	return m.UiVisibility
}

// SetUiVisibility sets the UiVisibility property
func (m *PatchedWritableCustomFieldRequest) SetUiVisibility(val string) {
	m.UiVisibility = val
}

// GetValidationMaximum returns the ValidationMaximum property
func (m PatchedWritableCustomFieldRequest) GetValidationMaximum() *int32 {
	return m.ValidationMaximum
}

// SetValidationMaximum sets the ValidationMaximum property
func (m *PatchedWritableCustomFieldRequest) SetValidationMaximum(val *int32) {
	m.ValidationMaximum = val
}

// GetValidationMinimum returns the ValidationMinimum property
func (m PatchedWritableCustomFieldRequest) GetValidationMinimum() *int32 {
	return m.ValidationMinimum
}

// SetValidationMinimum sets the ValidationMinimum property
func (m *PatchedWritableCustomFieldRequest) SetValidationMinimum(val *int32) {
	m.ValidationMinimum = val
}

// GetValidationRegex returns the ValidationRegex property
func (m PatchedWritableCustomFieldRequest) GetValidationRegex() string {
	return m.ValidationRegex
}

// SetValidationRegex sets the ValidationRegex property
func (m *PatchedWritableCustomFieldRequest) SetValidationRegex(val string) {
	m.ValidationRegex = val
}

// GetWeight returns the Weight property
func (m PatchedWritableCustomFieldRequest) GetWeight() int32 {
	return m.Weight
}

// SetWeight sets the Weight property
func (m *PatchedWritableCustomFieldRequest) SetWeight(val int32) {
	m.Weight = val
}
