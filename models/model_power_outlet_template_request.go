...
// PowerOutletTemplateRequest is an object. Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during
...
type PowerOutletTemplateRequest struct {
	...
	// dictionary of attributes which can be used to uniquely identify the related object. This class should be
	// subclassed to return a full representation of the related object on read.
	PowerPort *NestedPowerPortTemplateRequest `json:"power_port,omitempty" mapstructure:"power_port,omitempty"`
...
func (m PowerOutletTemplateRequest) Validate() error {
...
func (m PowerOutletTemplateRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *PowerOutletTemplateRequest) SetDescription(val string) {
	m.Description = val
}

// GetDeviceType returns the DeviceType property
func (m PowerOutletTemplateRequest) GetDeviceType() *NestedDeviceTypeRequest {
	return m.DeviceType
}

// SetDeviceType sets the DeviceType property
func (m *PowerOutletTemplateRequest) SetDeviceType(val *NestedDeviceTypeRequest) {
	m.DeviceType = val
}

// GetFeedLeg returns the FeedLeg property
func (m PowerOutletTemplateRequest) GetFeedLeg() *string {
	return m.FeedLeg
}

// SetFeedLeg sets the FeedLeg property
func (m *PowerOutletTemplateRequest) SetFeedLeg(val *string) {
	m.FeedLeg = val
}

// GetLabel returns the Label property
func (m PowerOutletTemplateRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *PowerOutletTemplateRequest) SetLabel(val string) {
	m.Label = val
}

// GetModuleType returns the ModuleType property
func (m PowerOutletTemplateRequest) GetModuleType() *NestedModuleTypeRequest {
	return m.ModuleType
}

// SetModuleType sets the ModuleType property
func (m *PowerOutletTemplateRequest) SetModuleType(val *NestedModuleTypeRequest) {
	m.ModuleType = val
}

// GetName returns the Name property
func (m PowerOutletTemplateRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *PowerOutletTemplateRequest) SetName(val string) {
	m.Name = val
}

// GetPowerPort returns the PowerPort property
func (m PowerOutletTemplateRequest) GetPowerPort() *NestedPowerPortTemplateRequest {
	return m.PowerPort
}

// SetPowerPort sets the PowerPort property
func (m *PowerOutletTemplateRequest) SetPowerPort(val *NestedPowerPortTemplateRequest) {
	m.PowerPort = val
}

// GetType returns the Type property
func (m PowerOutletTemplateRequest) GetType() *string {
	return m.Type
}

// SetType sets the Type property
func (m *PowerOutletTemplateRequest) SetType(val *string) {
	m.Type = val
}
