...
// PowerPortRequest is an object. Adds support for custom fields and tags.
...
func (m PowerPortRequest) Validate() error {
...
func (m PowerPortRequest) GetAllocatedDraw() *int32 {
	return m.AllocatedDraw
}

// SetAllocatedDraw sets the AllocatedDraw property
func (m *PowerPortRequest) SetAllocatedDraw(val *int32) {
	m.AllocatedDraw = val
}

// GetCustomFields returns the CustomFields property
func (m PowerPortRequest) GetCustomFields() map[string]interface{} {
	return m.CustomFields
}

// SetCustomFields sets the CustomFields property
func (m *PowerPortRequest) SetCustomFields(val map[string]interface{}) {
	m.CustomFields = val
}

// GetDescription returns the Description property
func (m PowerPortRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *PowerPortRequest) SetDescription(val string) {
	m.Description = val
}

// GetDevice returns the Device property
func (m PowerPortRequest) GetDevice() NestedDeviceRequest {
	return m.Device
}

// SetDevice sets the Device property
func (m *PowerPortRequest) SetDevice(val NestedDeviceRequest) {
	m.Device = val
}

// GetLabel returns the Label property
func (m PowerPortRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *PowerPortRequest) SetLabel(val string) {
	m.Label = val
}

// GetMarkConnected returns the MarkConnected property
func (m PowerPortRequest) GetMarkConnected() bool {
	return m.MarkConnected
}

// SetMarkConnected sets the MarkConnected property
func (m *PowerPortRequest) SetMarkConnected(val bool) {
	m.MarkConnected = val
}

// GetMaximumDraw returns the MaximumDraw property
func (m PowerPortRequest) GetMaximumDraw() *int32 {
	return m.MaximumDraw
}

// SetMaximumDraw sets the MaximumDraw property
func (m *PowerPortRequest) SetMaximumDraw(val *int32) {
	m.MaximumDraw = val
}

// GetModule returns the Module property
func (m PowerPortRequest) GetModule() *ComponentNestedModuleRequest {
	return m.Module
}

// SetModule sets the Module property
func (m *PowerPortRequest) SetModule(val *ComponentNestedModuleRequest) {
	m.Module = val
}

// GetName returns the Name property
func (m PowerPortRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *PowerPortRequest) SetName(val string) {
	m.Name = val
}

// GetTags returns the Tags property
func (m PowerPortRequest) GetTags() []NestedTagRequest {
	return m.Tags
}

// SetTags sets the Tags property
func (m *PowerPortRequest) SetTags(val []NestedTagRequest) {
	m.Tags = val
}

// GetType returns the Type property
func (m PowerPortRequest) GetType() *string {
	return m.Type
}

// SetType sets the Type property
func (m *PowerPortRequest) SetType(val *string) {
	m.Type = val
}
