...
// PowerPortTemplateRequest is an object. Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during
...
func (m PowerPortTemplateRequest) Validate() error {
...
func (m PowerPortTemplateRequest) GetAllocatedDraw() *int32 {
	return m.AllocatedDraw
}

// SetAllocatedDraw sets the AllocatedDraw property
func (m *PowerPortTemplateRequest) SetAllocatedDraw(val *int32) {
	m.AllocatedDraw = val
}

// GetDescription returns the Description property
func (m PowerPortTemplateRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *PowerPortTemplateRequest) SetDescription(val string) {
	m.Description = val
}

// GetDeviceType returns the DeviceType property
func (m PowerPortTemplateRequest) GetDeviceType() *NestedDeviceTypeRequest {
	return m.DeviceType
}

// SetDeviceType sets the DeviceType property
func (m *PowerPortTemplateRequest) SetDeviceType(val *NestedDeviceTypeRequest) {
	m.DeviceType = val
}

// GetLabel returns the Label property
func (m PowerPortTemplateRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *PowerPortTemplateRequest) SetLabel(val string) {
	m.Label = val
}

// GetMaximumDraw returns the MaximumDraw property
func (m PowerPortTemplateRequest) GetMaximumDraw() *int32 {
	return m.MaximumDraw
}

// SetMaximumDraw sets the MaximumDraw property
func (m *PowerPortTemplateRequest) SetMaximumDraw(val *int32) {
	m.MaximumDraw = val
}

// GetModuleType returns the ModuleType property
func (m PowerPortTemplateRequest) GetModuleType() *NestedModuleTypeRequest {
	return m.ModuleType
}

// SetModuleType sets the ModuleType property
func (m *PowerPortTemplateRequest) SetModuleType(val *NestedModuleTypeRequest) {
	m.ModuleType = val
}

// GetName returns the Name property
func (m PowerPortTemplateRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *PowerPortTemplateRequest) SetName(val string) {
	m.Name = val
}

// GetType returns the Type property
func (m PowerPortTemplateRequest) GetType() *string {
	return m.Type
}

// SetType sets the Type property
func (m *PowerPortTemplateRequest) SetType(val *string) {
	m.Type = val
}
