...
// rearPortColorPattern is the validation pattern for RearPort.Color
var rearPortColorPattern = regexp.MustCompile(`^[0-9a-f]{6}$`)

// RearPort is an object. Adds support for custom fields and tags.
...
func (m RearPort) Validate() error {
	return validation.Errors{
		"cable": validation.Validate(
			m.Cable,
		),
		"color": validation.Validate(
			m.Color, validation.Length(0, 6), validation.Match(rearPortColorPattern),
		),
...
func (m RearPort) GetOccupied() bool {
	return m.Occupied
}

// SetOccupied sets the Occupied property
func (m *RearPort) SetOccupied(val bool) {
	m.Occupied = val
}

// GetCable returns the Cable property
func (m RearPort) GetCable() *NestedCable {
	return m.Cable
}

// SetCable sets the Cable property
func (m *RearPort) SetCable(val *NestedCable) {
	m.Cable = val
}

// GetCableEnd returns the CableEnd property
func (m RearPort) GetCableEnd() string {
	return m.CableEnd
}

// SetCableEnd sets the CableEnd property
func (m *RearPort) SetCableEnd(val string) {
	m.CableEnd = val
}

// GetColor returns the Color property
func (m RearPort) GetColor() string {
	return m.Color
}

// SetColor sets the Color property
func (m *RearPort) SetColor(val string) {
	m.Color = val
}

// GetCreated returns the Created property
func (m RearPort) GetCreated() *time.Time {
	return m.Created
}

// SetCreated sets the Created property
func (m *RearPort) SetCreated(val *time.Time) {
	m.Created = val
}

// GetCustomFields returns the CustomFields property
func (m RearPort) GetCustomFields() map[string]interface{} {
	return m.CustomFields
}

// SetCustomFields sets the CustomFields property
func (m *RearPort) SetCustomFields(val map[string]interface{}) {
	m.CustomFields = val
}

// GetDescription returns the Description property
func (m RearPort) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *RearPort) SetDescription(val string) {
	m.Description = val
}

// GetDevice returns the Device property
func (m RearPort) GetDevice() NestedDevice {
	return m.Device
}

// SetDevice sets the Device property
func (m *RearPort) SetDevice(val NestedDevice) {
	m.Device = val
}

// GetDisplay returns the Display property
func (m RearPort) GetDisplay() string {
	return m.Display
}

// SetDisplay sets the Display property
func (m *RearPort) SetDisplay(val string) {
	m.Display = val
}

// GetId returns the Id property
func (m RearPort) GetId() int32 {
	return m.Id
}

// SetId sets the Id property
func (m *RearPort) SetId(val int32) {
	m.Id = val
}

// GetLabel returns the Label property
func (m RearPort) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *RearPort) SetLabel(val string) {
	m.Label = val
}

// GetLastUpdated returns the LastUpdated property
func (m RearPort) GetLastUpdated() *time.Time {
	return m.LastUpdated
}

// SetLastUpdated sets the LastUpdated property
func (m *RearPort) SetLastUpdated(val *time.Time) {
	m.LastUpdated = val
}

// GetLinkPeers returns the LinkPeers property
func (m RearPort) GetLinkPeers() []interface{} {
	return m.LinkPeers
}

// SetLinkPeers sets the LinkPeers property
func (m *RearPort) SetLinkPeers(val []interface{}) {
	m.LinkPeers = val
}

// GetLinkPeersType returns the LinkPeersType property
func (m RearPort) GetLinkPeersType() string {
	return m.LinkPeersType
}

// SetLinkPeersType sets the LinkPeersType property
func (m *RearPort) SetLinkPeersType(val string) {
	m.LinkPeersType = val
}

// GetMarkConnected returns the MarkConnected property
func (m RearPort) GetMarkConnected() bool {
	return m.MarkConnected
}

// SetMarkConnected sets the MarkConnected property
func (m *RearPort) SetMarkConnected(val bool) {
	m.MarkConnected = val
}

// GetModule returns the Module property
func (m RearPort) GetModule() *ComponentNestedModule {
	return m.Module
}

// SetModule sets the Module property
func (m *RearPort) SetModule(val *ComponentNestedModule) {
	m.Module = val
}

// GetName returns the Name property
func (m RearPort) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *RearPort) SetName(val string) {
	m.Name = val
}

// GetPositions returns the Positions property
func (m RearPort) GetPositions() int32 {
	return m.Positions
}

// SetPositions sets the Positions property
func (m *RearPort) SetPositions(val int32) {
	m.Positions = val
}

// GetTags returns the Tags property
func (m RearPort) GetTags() []NestedTag {
	return m.Tags
}

// SetTags sets the Tags property
func (m *RearPort) SetTags(val []NestedTag) {
	m.Tags = val
}

// GetType returns the Type property
func (m RearPort) GetType() struct {
	Label string `json:"label,omitempty" mapstructure:"label,omitempty"`
	Value string `json:"value,omitempty" mapstructure:"value,omitempty"`
} {
	return m.Type
...
func (m *RearPort) SetType(val struct {
	Label string `json:"label,omitempty" mapstructure:"label,omitempty"`
	Value string `json:"value,omitempty" mapstructure:"value,omitempty"`
}) {
	m.Type = val
...
func (m RearPort) GetUrl() string {
	return m.Url
}

// SetUrl sets the Url property
func (m *RearPort) SetUrl(val string) {
	m.Url = val
}
