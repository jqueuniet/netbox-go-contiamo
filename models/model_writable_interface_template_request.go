...
// WritableInterfaceTemplateRequest is an object. Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during
...
func (m WritableInterfaceTemplateRequest) Validate() error {
...
func (m WritableInterfaceTemplateRequest) GetBridge() *int32 {
	return m.Bridge
}

// SetBridge sets the Bridge property
func (m *WritableInterfaceTemplateRequest) SetBridge(val *int32) {
	m.Bridge = val
}

// GetDescription returns the Description property
func (m WritableInterfaceTemplateRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *WritableInterfaceTemplateRequest) SetDescription(val string) {
	m.Description = val
}

// GetDeviceType returns the DeviceType property
func (m WritableInterfaceTemplateRequest) GetDeviceType() *int32 {
	return m.DeviceType
}

// SetDeviceType sets the DeviceType property
func (m *WritableInterfaceTemplateRequest) SetDeviceType(val *int32) {
	m.DeviceType = val
}

// GetEnabled returns the Enabled property
func (m WritableInterfaceTemplateRequest) GetEnabled() bool {
	return m.Enabled
}

// SetEnabled sets the Enabled property
func (m *WritableInterfaceTemplateRequest) SetEnabled(val bool) {
	m.Enabled = val
}

// GetLabel returns the Label property
func (m WritableInterfaceTemplateRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *WritableInterfaceTemplateRequest) SetLabel(val string) {
	m.Label = val
}

// GetMgmtOnly returns the MgmtOnly property
func (m WritableInterfaceTemplateRequest) GetMgmtOnly() bool {
	return m.MgmtOnly
}

// SetMgmtOnly sets the MgmtOnly property
func (m *WritableInterfaceTemplateRequest) SetMgmtOnly(val bool) {
	m.MgmtOnly = val
}

// GetModuleType returns the ModuleType property
func (m WritableInterfaceTemplateRequest) GetModuleType() *int32 {
	return m.ModuleType
}

// SetModuleType sets the ModuleType property
func (m *WritableInterfaceTemplateRequest) SetModuleType(val *int32) {
	m.ModuleType = val
}

// GetName returns the Name property
func (m WritableInterfaceTemplateRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *WritableInterfaceTemplateRequest) SetName(val string) {
	m.Name = val
}

// GetPoeMode returns the PoeMode property
func (m WritableInterfaceTemplateRequest) GetPoeMode() string {
	return m.PoeMode
}

// SetPoeMode sets the PoeMode property
func (m *WritableInterfaceTemplateRequest) SetPoeMode(val string) {
	m.PoeMode = val
}

// GetPoeType returns the PoeType property
func (m WritableInterfaceTemplateRequest) GetPoeType() string {
	return m.PoeType
}

// SetPoeType sets the PoeType property
func (m *WritableInterfaceTemplateRequest) SetPoeType(val string) {
	m.PoeType = val
}

// GetType returns the Type property
func (m WritableInterfaceTemplateRequest) GetType() string {
	return m.Type
}

// SetType sets the Type property
func (m *WritableInterfaceTemplateRequest) SetType(val string) {
	m.Type = val
}
