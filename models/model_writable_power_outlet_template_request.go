...
// WritablePowerOutletTemplateRequest is an object. Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during
...
func (m WritablePowerOutletTemplateRequest) Validate() error {
...
func (m WritablePowerOutletTemplateRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *WritablePowerOutletTemplateRequest) SetDescription(val string) {
	m.Description = val
}

// GetDeviceType returns the DeviceType property
func (m WritablePowerOutletTemplateRequest) GetDeviceType() *int32 {
	return m.DeviceType
}

// SetDeviceType sets the DeviceType property
func (m *WritablePowerOutletTemplateRequest) SetDeviceType(val *int32) {
	m.DeviceType = val
}

// GetFeedLeg returns the FeedLeg property
func (m WritablePowerOutletTemplateRequest) GetFeedLeg() string {
	return m.FeedLeg
}

// SetFeedLeg sets the FeedLeg property
func (m *WritablePowerOutletTemplateRequest) SetFeedLeg(val string) {
	m.FeedLeg = val
}

// GetLabel returns the Label property
func (m WritablePowerOutletTemplateRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *WritablePowerOutletTemplateRequest) SetLabel(val string) {
	m.Label = val
}

// GetModuleType returns the ModuleType property
func (m WritablePowerOutletTemplateRequest) GetModuleType() *int32 {
	return m.ModuleType
}

// SetModuleType sets the ModuleType property
func (m *WritablePowerOutletTemplateRequest) SetModuleType(val *int32) {
	m.ModuleType = val
}

// GetName returns the Name property
func (m WritablePowerOutletTemplateRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *WritablePowerOutletTemplateRequest) SetName(val string) {
	m.Name = val
}

// GetPowerPort returns the PowerPort property
func (m WritablePowerOutletTemplateRequest) GetPowerPort() *int32 {
	return m.PowerPort
}

// SetPowerPort sets the PowerPort property
func (m *WritablePowerOutletTemplateRequest) SetPowerPort(val *int32) {
	m.PowerPort = val
}

// GetType returns the Type property
func (m WritablePowerOutletTemplateRequest) GetType() string {
	return m.Type
}

// SetType sets the Type property
func (m *WritablePowerOutletTemplateRequest) SetType(val string) {
	m.Type = val
}
