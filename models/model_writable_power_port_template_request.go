...
// WritablePowerPortTemplateRequest is an object. Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during
...
func (m WritablePowerPortTemplateRequest) Validate() error {
...
func (m WritablePowerPortTemplateRequest) GetAllocatedDraw() *int32 {
	return m.AllocatedDraw
}

// SetAllocatedDraw sets the AllocatedDraw property
func (m *WritablePowerPortTemplateRequest) SetAllocatedDraw(val *int32) {
	m.AllocatedDraw = val
}

// GetDescription returns the Description property
func (m WritablePowerPortTemplateRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m *WritablePowerPortTemplateRequest) SetDescription(val string) {
	m.Description = val
}

// GetDeviceType returns the DeviceType property
func (m WritablePowerPortTemplateRequest) GetDeviceType() *int32 {
	return m.DeviceType
}

// SetDeviceType sets the DeviceType property
func (m *WritablePowerPortTemplateRequest) SetDeviceType(val *int32) {
	m.DeviceType = val
}

// GetLabel returns the Label property
func (m WritablePowerPortTemplateRequest) GetLabel() string {
	return m.Label
}

// SetLabel sets the Label property
func (m *WritablePowerPortTemplateRequest) SetLabel(val string) {
	m.Label = val
}

// GetMaximumDraw returns the MaximumDraw property
func (m WritablePowerPortTemplateRequest) GetMaximumDraw() *int32 {
	return m.MaximumDraw
}

// SetMaximumDraw sets the MaximumDraw property
func (m *WritablePowerPortTemplateRequest) SetMaximumDraw(val *int32) {
	m.MaximumDraw = val
}

// GetModuleType returns the ModuleType property
func (m WritablePowerPortTemplateRequest) GetModuleType() *int32 {
	return m.ModuleType
}

// SetModuleType sets the ModuleType property
func (m *WritablePowerPortTemplateRequest) SetModuleType(val *int32) {
	m.ModuleType = val
}

// GetName returns the Name property
func (m WritablePowerPortTemplateRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m *WritablePowerPortTemplateRequest) SetName(val string) {
	m.Name = val
}

// GetType returns the Type property
func (m WritablePowerPortTemplateRequest) GetType() string {
	return m.Type
}

// SetType sets the Type property
func (m *WritablePowerPortTemplateRequest) SetType(val string) {
	m.Type = val
}
